<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="Studio.aspx.cs" Inherits="PWeb_Quiz2.Studio" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        body {
        background-image: url('Images/StudioBW3.jpg');
        ...
        <div>
            ...
            <div class="input-group">
                <div class="form-inline">    
                    <h2 class="alert title-text text-center">Studio Available</h2>          
                    <table border="0" cellpadding="5" cellspacing="5" class="table bg-success ">
                        ...
                        <tr>
                            <td class="auto-style2">
                                <asp:TextBox runat="server" ID="txtStudentId" class="form-control" placeholder="Studio" required  CssClass="form-control"/>
                            </td>
                            <td class="auto-style2">
          ...
          <asp:GridView ID="GridView1" runat="server" 
                ...
                DataKeyNames="UserId" DataSourceID="LibraryDb" Width="600px">
              <Columns>
                 
                  <asp:BoundField DataField="UserId" HeaderText="UserId" 
                      SortExpression="UserId" ReadOnly="True" InsertVisible="False" Visible="False"  />
                  <asp:BoundField DataField="UserName" HeaderText="Studio UserName" 
